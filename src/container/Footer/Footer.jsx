    ...
    <>
      ...
      <div className='app__footer-cards'>
        <div className='app__footer-card'>
          ...
          <a href="mailto:hello@test.com" className='p-text'>edwin@email.com</a>
        </div>
        <div className='app__footer-card'>
          <img src={images.mobile} alt="mobile" />
          <a href="mailto:tel: +1 (123) 456-789" className='p-text'>+507 (123) 456-789</a>
        </div>
      </div>
      ...
      : <div>
          <h3 className='head-text'>Thank you for getting in touch!
        </h3>
      </div>
      }
      </>
